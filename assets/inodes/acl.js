...
async function submitChanges() {
  ...
  flashNow(`Access for ${inodeLabel.toLowerCase()} "${inodeName}" saved`);
  statusSignal.value = "closed";
}
    ...
    `
        <dialog id="acl-dialog">
          ...
          <form id="acl-form" class="basic">
            ...
            <p>
              <label><input type="checkbox" id="pub-acl" ${pubAccessCheckAttr} /> Public</label>
            </p>
            <fieldset class="permissions">
              <legend>Roles</legend>
              <div id="acl-items"></div>
              <button id="acl-add-user" type="button"><i class="ico-plus-lg"></i>User</button>
              <p hidden id="acl-loading"><span class="spinner-sm"></span>Loading</p>
            </fieldset>
            <footer>
              <button type="button" id="acl-close">Cancel</button>
              <button id="acl-submit">Save</button>
            </footer>
          </form>
        </dialog>
      `
