...
export default async function termPageHandler(ctx: Context) {
  ...
  return (
    <Page title={title} header={{ linkHome: true }}>
      <div class="prose">
        ...
        <p>
          Welcome to{" "}
          {SITE_NAME}. By using this website, you agree to the following terms.
        ...
        <p>
          {SITE_NAME}{" "}
          is a file-storage platform that allows registered users to upload and
          share files publicly or privately. {initialUploaQuota > 0 && (
            <>
              Each user receives{" "}
        ...
        <p>
          ...
          <a href={`mailto:${SUPPORT_EMAIL}`}>{SUPPORT_EMAIL}</a>. Refund
        ...
        <p>You may not use {SITE_NAME} to upload or distribute:</p>
        ...
        <p>
          {SITE_NAME}{" "}
          is developed and maintained by an independent developer. While I
          strive to maintain uptime and reliability, service interruptions or
