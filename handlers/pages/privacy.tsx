...
export default function privacyPageHandler(ctx: Context) {
    ...
    <Page title={title} header={{ linkHome: true }}>
      <div class="prose">
        ...
        <p>
          ...
          <strong>{SITE_NAME}</strong> collects and how it is used.
        </p>
        ...
        <p>
          ...
          is completely secure. Use {SITE_NAME} at your own discretion.
        </p>
