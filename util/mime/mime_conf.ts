...
// deno-fmt-ignore
export const MIME_CONF: Record<string, MimeConf> = {
  ...
  "application/x-javascript": { title: "Plain Text Document", display: "iframe", proc: "highlight", to: "text/html", codeLang: "javascript" },
  ...
  "text/csv": { title: "CSV Document", proc: "csv_parser", to: "text/html" },
  "text/markdown": { title: "Markdown Document", proc: "pandoc", to: "text/html" },
  "text/plain": { title: "Plain Text Document", display: "iframe", proc: "highlight", to: "text/html", codeLang: "auto" },
  ...
  "video/mp2t": { title: "MPEG-2 Transport Stream", proc: "aws_mediaconvert" },
